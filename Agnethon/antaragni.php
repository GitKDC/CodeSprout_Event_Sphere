...
<head>
    ...
    <link rel="stylesheet" href="antaragni.css">
...
<body>
    <div class="upper">
        <div class="nav">
            ...
            <ul style="margin-right: 9vw;" class="list">
                <li id="li1"><a href="../index.html">Home</a></li>
                <li id="li2"><a href="./Even.html">Events</a></li>
    ...
    <section>
        <div class="container">
            <h1 style="padding-top: 3vw; font-size: 4vw;"><B>ANTARAGNI 2024</B></h1>
            <p>A journey towards excellence.
            </p>
            <br>
        </div>
    </section>
        ...
        <div id="kashti">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Time: Batminton Court, Main Building</p>
                    <p class="card-text">Co-ordinators: Swapnil Shrawane , Kartik Deshmukh</p>
                    <pre class="card-text"><b>Theme</b>: <br>26th Feb- Kids Day / Mismatch Day <br>28th Feb- Traditional Day / Group Day</pre>
            ...
            <div class="card" style="width: 18rem;">
                    <img src="./assets/pexels-mark-angelo-sampan-1587927.jpg" class="card-img-top" alt="">
                    <div class="card-body">
                        <h5 style="font-size: 3vw;" class="card-title"><b>Antakshari</b></h5>
